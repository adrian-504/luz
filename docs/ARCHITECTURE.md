...
| Media session | Media3 `MediaSession` (`PlaybackMediaSession`, ADR-0027) | Hardware media keys, assistant, system controls; commands go through the controller; title/subtitle only |
